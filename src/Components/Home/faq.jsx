...
function FAQ() {
  ...
  return (
    <div className="bg-white py-40 flex flex-row items-start justify-start">
      ...
      <div id="accordion-flush" className="text-center ">
        <h4 className="font-bold mb-[16px] mt-[-50px]">
          ...
          <div key={index}>
            ...
            >
              <div className="py-5 text-left border-b border-gray-200 ">
                <p className="mb-2 text-sm text-black ">{item.answer}</p>
              </div>
            </div>
          </div>
        ))}
